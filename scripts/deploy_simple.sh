...
echo "🚀 Deploy Semplificato SecureVox"
echo "================================"
...
# 1. Crea uno script di installazione semplice
echo "📝 Creando script di installazione semplice..."
cat > securevox_simple_install.sh << 'EOF'
#!/bin/bash
set -e
...
echo "6. Esegui: wget https://raw.githubusercontent.com/your-repo/securevox_simple_install.sh"
echo "7. Esegui: chmod +x securevox_simple_install.sh && ./securevox_simple_install.sh"
echo ""
echo "🌐 Dopo l'installazione, SecureVox sarà disponibile su:"
echo "   - http://$PUBLIC_IP"
echo "   - http://$PUBLIC_IP/api/"
echo "   - http://$PUBLIC_IP/app-distribution/"
